...
class LLL_Net(nn.Module):
    ...
    def __init__(self, model,  data_type="residual", remove_existing_head=False):
    ...
    def forward(self, x, return_features=False):
        ...
        """
        if self.data_type == "rgb" or self.data_type == "gray" or self.data_type == "residual":
            x = self.model(x[0])
        
        elif self.data_type == "residual_hist":
